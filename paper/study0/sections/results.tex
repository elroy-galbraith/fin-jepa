...
The formal gate criterion requires the FT-Transformer to beat XGBoost by $\geq 0.01$ AUROC on at least 3 of 4 outcomes. With the current results (scratch FT-Transformer, untuned):
