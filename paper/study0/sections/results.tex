...
\begin{figure}[ht]
  ...
  \caption{Walk-forward AUROC difference (FT-Transformer minus XGBoost) across the seven expanding-window folds. The shaded band marks the two COVID-era test windows; the dotted line is the 0.01 gate margin. The \texttt{earnings\_restate} advantage is flat and consistently above the margin, whereas \texttt{bankruptcy} reverses through the COVID boundary and the rare-event \texttt{sec\_enforcement} margin decays over time.}
