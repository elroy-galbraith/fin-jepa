...
\begin{enumerate}[leftmargin=*]
  ...
  \item \textbf{Feature definitions and normalization code}---16 raw features, 12 financial ratios, 16 YoY changes, with configurable winsorization and quantile normalization.
