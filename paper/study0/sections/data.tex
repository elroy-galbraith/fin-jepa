...
The default configuration uses all feature groups (raw + ratios + YoY + missingness flags), yielding 45 numeric features (16 raw + 12 ratios + 16 YoY + 1 \texttt{is\_first\_year}) plus one categorical feature (\texttt{sector\_idx}, Fama--French 12-industry) and their corresponding missingness indicators.
...
\todo{Verify final label coverage statistics from Colab notebook run (ATS-172).}
