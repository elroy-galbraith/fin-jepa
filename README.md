...
│   └── study0/
├── scripts/                # Standalone pipeline runners & utilities
...
| `earnings_restate` | EDGAR index + XBRL facts | Reconciled 10-K/A amendment + XBRL duplicate-filing detection (configurable) |
